// Code generated by crd-parser. DO NOT EDIT.
...
the controller and webhook components.
	Additionaloutputformats []interface{} `json:"additionalOutputFormats,omitempty"`
...
You should ensure that any OID passed is valid for the UTF8String type as we do not explicitly validate this.
	Othernames []interface{} `json:"otherNames,omitempty"`
