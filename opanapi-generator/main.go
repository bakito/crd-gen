...
func generateGroupVersionInfoCode(group, version string, kinds []string) string {
	var sb strings.Builder
	...
	for _, kind := range kinds {
		writef(&sb, "\tSchemeBuilder.Register(&%s{}, &%sList{})\n", kind, kind)
	}
	write(&sb, "}\n\n")
...
func main() {
	...
	gvi := generateGroupVersionInfoCode(crdGroup, version, kinds)
